...
import { type Fleet, useFleets } from "./fleets-context";
    ...
    <div className="flex-1 bg-background p-8">
      <div className="mx-auto max-w-6xl">
        ...
        {state.isLoading ? (
          ...
          <ErrorState
            title="Error al cargar flotas"
            error={state.error}
            onRetry={actions.fetchFleets}
          />
      ...
      <td className="whitespace-nowrap px-6 py-4 text-right text-sm">
        <Can perm="fleet:update">
          <Button
            variant="ghost"
            size="sm"
            onClick={() => actions.setEditingFleet(fleet)}
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    ...
                    <strong>{fleet.name}</strong>. Los vehículos y conductores
                    asignados no se verán afectados.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-background p-4">
      <div className="flex items-center justify-between mb-3">
        <div>
          <h1 className="text-lg font-semibold text-foreground">
            {state.editingFleet ? "Editar Flota" : "Nueva Flota"}
          </h1>
      ...
      <div className="flex-1 min-h-0">
        <FleetForm
          onSubmit={
            state.editingFleet ? actions.handleUpdate : actions.handleCreate
          }
          initialData={
            state.editingFleet
              ? {
                  ...state.editingFleet,
                  type: (state.editingFleet.type as FleetInput["type"]) || null,
                }
              : undefined
          }
