...
- **Motor de optimizacion**: Los parametros del preset se traducen automaticamente al formato que requiere VROOM, el unico motor de optimizacion de la plataforma (PyVRP fue removido — ver ADR-0001).
